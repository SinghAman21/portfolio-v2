...
![kubectl get hpa mini-order-backend watch output stepping from 2 to 5 to 8 replicas as the TARGETS column climbs past 70 percent under k6 load](/blog/devops/9-horizontal-pod-autoscaling/hpa-scaling-up.png "The whole control loop happening live: CPU crosses target, replicas jump to match")
