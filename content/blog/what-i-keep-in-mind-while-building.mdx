...
This is the kind of DAL/DTL-style separation I like to keep in mind while structuring backend work:

![DAL and DTL backend flow diagram](/dal-dtl.png "DAL and DTL backend flow")

For backend template inspiration, I also keep this reference handy: [backend template gist](https://gist.github.com/SinghAman21/b2a5c1309ddff0f082053d0be9c38290).
