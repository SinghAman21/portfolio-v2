...
export const contributions: OpenSourceContribution[] = [
  ...
  },
  {
    ...
    number: 2581,
    title: "fix(dashboard): expose auth user id in session",
    status: "open",
    url: "https://github.com/openstatusHQ/openstatus/pull/2581",
  },
  {
    kind: "pr",
    repo: "helm/helm",
    number: 32564,
    title: "fix(action): skip existing release namespace creation",
    status: "open",
    url: "https://github.com/helm/helm/pull/32564",
  },
  {
    kind: "pr",
    repo: "Graphify-Labs/graphify",
    number: 2972,
    title: "fix(extract): disambiguate python calls by from-import",
    status: "open",
    url: "https://github.com/Graphify-Labs/graphify/pull/2972",
  },
  {
    kind: "pr",
    repo: "pipe-cd/pipecd",
    number: 7277,
    title: "fix(config): include unsupported type in SecretManagement unmarshal error",
    status: "open",
    url: "https://github.com/pipe-cd/pipecd/pull/7277",
  },
  {
    kind: "pr",
    repo: "Graphify-Labs/graphify",
  ...
  },
  {
    ...
    repo: "Graphify-Labs/graphify",
    number: 2928,
    title: "fix(extract): scope fresh semantic results to dispatched files (#2926)",
    status: "merged",
    url: "https://github.com/Graphify-Labs/graphify/pull/2928",
  },
  {
    kind: "pr",
    repo: "helm/helm-www",
  ...
  },
  {
    ...
    repo: "Graphify-Labs/graphify",
    number: 2936,
    title: "fix(cache): skip caching edges-but-no-nodes semantic results so model-omitted files re-dispatch instead of freezing out of the graph",
    status: "closed",
    url: "https://github.com/Graphify-Labs/graphify/pull/2936",
  },
];
